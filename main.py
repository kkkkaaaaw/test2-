...
def generate_briefing(client, model_name, comp_raw, weihai_raw, ind_data_dict, finance_raw, macro_raw, tech_raw):
    ...
    一、 重点企业动态（强制生成 15 条）：
        ...
        【核心必保筛选】：
          1. 优先筛选{TARGET_COMPANIES}的重大涉外动作（如大额海外订单、海外工厂落地、国际认证获取），至少占8条，确保覆盖预期核心动态；
          2. 优先筛选威海龙头企业（威高、三角轮胎、威海广泰等）的产能扩建/跨境合作，至少占4条；
        【惊喜挖掘筛选】：
          1. 主动挖掘威海中小微企业的非传统市场突破（如中亚/中东/拉美订单、小众领域国际专利、意外跨界合作），至少占2条，提供意想不到的增长点；
          2. 主动挖掘威海企业在新兴赛道（低空经济、合成生物、深海装备）的涉外布局或潜在风险预警，至少占1条，突出隐藏机遇或挑战；
    ...
    二、 威海本地政经（强制生成 8 条）：
        ...
        【核心必保筛选】：
          1. 优先筛选威海市级层面发布的外贸/招商政策、重大产业项目签约，至少占4条，确保预期政经焦点覆盖；
          2. 优先筛选荣成/文登/乳山的核心产业升级动态，至少占2条；
        【惊喜挖掘筛选】：
          1. 主动挖掘威海对接非传统合作区域的政策（如中亚自贸区对接、中东经贸走廊、意外地缘机遇），至少占1条，提供意想不到的战略洞见；
          2. 主动挖掘威海细分产业（渔具/家纺/海洋食品）的隐藏政策红利或潜在挑战，至少占1条，突出非明显影响；
        【关键词规则升级】：词1为"事实标签"（如"招商引资"），词2为"价值标签"（如"新质生产力布局"）。
    
    三、 行业风向（每个行业 2 条）：
        禁止聚焦单一企业公关稿。每个行业配齐一内一外共两条新闻。新闻内容须为行业内最新突破、重大利好或利空、可能影响行业的重要事件及其影响。
        【核心必保筛选】：优先筛选威海支柱产业（医疗器械、轮胎、海洋经济）的行业动向，至少覆盖3个行业，确保预期行业趋势覆盖；
        【惊喜挖掘筛选】：主动挖掘威海小众优势行业（渔具、家纺、高端装备）的国际行业规则变动（如欧盟绿色壁垒、东南亚市场标准、意外跨界融合），至少覆盖1个行业，提供意想不到的全球影响；
    ...
    四、 金融与银行（强制生成 8 条）：
        ...
        【核心必保筛选】：优先筛选对威海出口企业影响最大的金融指标（如美元汇率、出口信贷利率），至少占5条，确保预期金融动态覆盖；
        【惊喜挖掘筛选】：主动挖掘小众金融工具（如跨境人民币结算、海外仓融资）在威海的落地动态或意外应用，至少占1条，提供意想不到的融资机会；
    ...
    五、 宏观与全球重点局势（强制生成 7 条）：
        ...
        【核心必保筛选】：优先筛选影响威海核心贸易伙伴（日韩、欧盟）的局势，至少占4条，确保预期全球影响覆盖；
        【惊喜挖掘筛选】：主动挖掘影响威海非传统贸易区（中亚、中东）的局势、小众大宗商品（橡胶、海产品）价格变动或意外地缘事件，至少占2条，提供意想不到的风险/机遇；
    ...
    六、 科技前沿与大语言模型（强制生成 9 条）：
        ...
        【核心必保筛选】：优先筛选与威海产业结合的科技进展（如医疗AI、轮胎智能制造），至少占3条，确保预期科技应用覆盖；
        【惊喜挖掘筛选】：主动挖掘可能颠覆威海传统产业的前沿科技（如深海AI检测、跨境电商AI翻译、意外AI跨界），至少占2条，提供意想不到的创新洞见；
